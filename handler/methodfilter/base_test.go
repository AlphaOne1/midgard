...
func TestHandlerNil(t *testing.T) {
	...
	var handler *methodfilter.Handler
...
func TestOptionError(t *testing.T) {
	...
	errOpt := func( /* h */ *methodfilter.Handler) error {
		return errors.New("testerror")
	}

	_, err := methodfilter.New(errOpt)
...
func TestHandlerNextNil(t *testing.T) {
	...
	h := helper.Must(methodfilter.New(methodfilter.WithLogLevel(slog.LevelDebug)))(nil)
...
func TestOptionWithLevel(t *testing.T) {
	...
	h := helper.Must(methodfilter.New(methodfilter.WithLogLevel(slog.LevelDebug)))(http.HandlerFunc(helper.DummyHandler))

	val, isValid := h.(*methodfilter.Handler)
...
func TestOptionWithLevelOnNil(t *testing.T) {
	...
	err := methodfilter.WithLogLevel(slog.LevelDebug)(nil)
...
func TestOptionWithLogger(t *testing.T) {
	...
	h := helper.Must(methodfilter.New(methodfilter.WithLogger(l)))(http.HandlerFunc(helper.DummyHandler))
...
func TestOptionWithLoggerOnNil(t *testing.T) {
	...
	err := methodfilter.WithLogger(slog.Default())(nil)
...
func TestOptionWithNilLogger(t *testing.T) {
	...
	var l *slog.Logger
	_, hErr := methodfilter.New(methodfilter.WithLogger(l))
