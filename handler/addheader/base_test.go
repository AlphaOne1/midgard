...
func TestOptionError(t *testing.T) {
	...
	errOpt := func( /* h */ *addheader.Handler) error {
		return errors.New("testerror")
	}

	_, err := addheader.New(errOpt)
...
func TestHandlerNextNil(t *testing.T) {
	...
	h := helper.Must(addheader.New(addheader.WithLogLevel(slog.LevelDebug)))(nil)
...
func TestOptionWithLevel(t *testing.T) {
	...
	h := helper.Must(addheader.New(addheader.WithLogLevel(slog.LevelDebug)))(http.HandlerFunc(helper.DummyHandler))

	val, isValid := h.(*addheader.Handler)
...
func TestOptionWithLevelOnNil(t *testing.T) {
	...
	err := addheader.WithLogLevel(slog.LevelDebug)(nil)
...
func TestOptionWithLogger(t *testing.T) {
	...
	h := helper.Must(addheader.New(addheader.WithLogger(l)))(http.HandlerFunc(helper.DummyHandler))
...
func TestOptionWithLoggerOnNil(t *testing.T) {
	...
	err := addheader.WithLogger(slog.Default())(nil)
...
func TestOptionWithNilLogger(t *testing.T) {
	...
	var l *slog.Logger
	_, hErr := addheader.New(addheader.WithLogger(l))
