...
func TestHandlerNil(t *testing.T) {
	...
	var handler *access_log.Handler
...
func TestOptionError(t *testing.T) {
	...
	errOpt := func( /* h */ *access_log.Handler) error {
		return errors.New("testerror")
	}

	_, err := access_log.New(errOpt)
...
func TestHandlerNextNil(t *testing.T) {
	...
	h := util.Must(access_log.New(access_log.WithLogLevel(slog.LevelDebug)))(nil)
...
func TestOptionWithLevel(t *testing.T) {
	...
	h := util.Must(access_log.New(access_log.WithLogLevel(slog.LevelDebug)))(http.HandlerFunc(util.DummyHandler))

	val, isValid := h.(*access_log.Handler)
...
func TestOptionWithLevelOnNil(t *testing.T) {
	...
	err := access_log.WithLogLevel(slog.LevelDebug)(nil)
...
func TestOptionWithLogger(t *testing.T) {
	...
	h := util.Must(access_log.New(access_log.WithLogger(l)))(http.HandlerFunc(util.DummyHandler))
...
func TestOptionWithLoggerOnNil(t *testing.T) {
	...
	err := access_log.WithLogger(slog.Default())(nil)
...
func TestOptionWithNilLogger(t *testing.T) {
	...
	var l *slog.Logger
	_, hErr := access_log.New(access_log.WithLogger(l))
