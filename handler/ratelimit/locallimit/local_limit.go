...
// ErrZeroRate is returned when the rate is 0.
var ErrZeroRate = errors.New("rate must be greater than 0")

// ErrZeroSleepTime is returned when the sleep time is 0.
var ErrZeroSleepTime = errors.New("sleep time must be greater than 0")
