...
func Must[T any](val T, err error) T { //nolint:ireturn // as a generic, it must return the type that way
	if err != nil {
...
// order of the elements in that slice. A nil map will produce a nil result, an empty map produces an empty
// slice.
